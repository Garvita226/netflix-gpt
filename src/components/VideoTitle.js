  ...
  return (
    <div className='z-30 absolute text-white pt-[20%] px-12 w-screen aspect-video bg-gradient-to-r from-black'>
      ...
      <div>
        ...
        <button className='bg-gray-500 text-white text-lg font-bold my-2 ml-2 py-2 px-6 rounded-md bg-opacity-50 hover:bg-opacity-70'> <i className="fa-solid fa-circle-info" style={{color: "#ffffff"}}></i> More Info</button>
      </div>
    </div>
  )
}
